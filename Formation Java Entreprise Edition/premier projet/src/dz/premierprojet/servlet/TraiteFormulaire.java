...
public class TraiteFormulaire extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		pw.println("Bienvenu"+" "+nom+" "+prenom+"<br>Vous êtes de sexe: "+sexe+"<br>Vous êtes de niveau:"+" "+niveau);
		...
		if(moy < 10.0)
			pw.println("<br>Vous avez "+moy+" de moyenne. Vous êtes ajourné(e)");
		else
			pw.println("<br>Vous avez "+moy+" de moyenne. Bravo vous êtes admis(e)!");
